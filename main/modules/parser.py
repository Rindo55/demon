...
def trim_title(title: str):
    ...
    title = title.replace("BLEACH.Thousand-Year.Blood.War.S02E02.PEACE.FROM.SHADOWS.1080p.DSNP.WEB-DL.AAC2.0.x264.mkv", "Bleach Thousand Year Blood War The Separation - 02")
    ext = ".mkv"
    title = title + ext
    return title
