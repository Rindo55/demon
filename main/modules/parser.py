...
def trim_title(title: str):
    ...
    title = title.replace("[CameEsp] Tokyo Revengers - Tenjiku Hen - 01 [1080p][ESP-ENG][mkv]", "Tokyo Revengers - Tenjiku Hen - 01")
    ext = ".mkv"
    title = title + ext
    return title

def parse():
    a = feedparser.parse("https://nyaa.si/?page=rss&u=Mayansito&q=tokyo%201080p")
    b = a["entries"]
    b = b[0:1]
    data = []    
